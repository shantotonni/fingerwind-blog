...
@section('title')
    FingerWind | Privacy Policy Page
@endsection
@section('content')
    ...
    <div class="main-body">
        <div class="container wrap">
            <div class="col-md-12 content-left">
                <div class="articles">
                    <header>
                        <h3 class="title-head">Privacy Policy</h3>
                    </header>

                    <div class="contact_grid">
                        <div class="col-md-12 contact-top">
                        <p>
                            The following Privacy Policy governs the online information collection practices of Fingerwind. ("we" or "us"). Specifically, it outlines the types of information that we gather about you while you are using the Fingerwind website (the "Site"), and the ways in which we use this information. This Privacy Policy,  does not apply to any information you may provide to us or that we may collect offline and/or through other means (for example, at a live event, via telephone, or through the mail).
                            Please read this Privacy Policy carefully. By visiting and using the Site, you agree that your use of our Site, and any dispute over privacy, is governed by this Privacy Policy. Because the Web is an evolving medium, we may need to change our Privacy Policy at some point in the future, in which case we'll post the changes to this Privacy Policy on this website and update the Effective Date of the policy to reflect the date of the changes. By continuing to use the Site after we post any such changes, you accept the Privacy Policy as modified.
                        </p>
                            <br>
                            <h4 style="font-weight: bold">How We Collect and Use Information</h4>
                            <br>
                            <p>
                                We may collect and store personal or other information that you voluntarily supply to us online while using the Site (e.g., while on the Site or in responding via email to a feature provided on the Site). Fingerwind  only contacts individuals who specifically request that we do so or in the event that they have signed up to receive our messaging, attended one of our events, or have purchased one of our products. Fingerwind collects personally identifying information from our users during online registration and online purchasing. Generally, this information includes name and e-mail address for registration or opt-in purposes and name, postal address, and credit card information when registering for our events or purchasing our products. All of this information is provided to us by you.
                                <br>
                            ...
                            <br>
                            <h4 style="font-weight: bold">Facebook</h4>
                            <p>
                                Facebook
                            ...
                            <br>
                            <h4 style="font-weight: bold">We abide by Facebook’s Data Use Restrictions</h4>
                            <p>
                            ...
                            <br>
                            <h4 style="font-weight: bold">How do we store your information?</h4>
                            <p>
                                Your information is stored at the list server that delivers Fingerwind content and messaging. Your information can only be accessed by those who help manage those lists in order to deliver e-mail to those who would like to receive Fingerwind material.
                                All of the messaging or emails that are sent to you by Fingerwind include an unsubscribe link in them. You can remove yourself at any time from our mailing list by clicking on the unsubscribe link that can be found in every communication that we send you.
